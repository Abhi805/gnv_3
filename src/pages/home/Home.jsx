          ...
          <div className="row">
            ...
            <div className="col-md-7">
              ...
              <p className="text-secondary">
                Event Management Company, a group of dynamic professionals working
                with prestigious names in the industry.
              </p>
      ...
      <div className="container-fluid mt-5">
        <div className="row">
          ...
          <div className="col-lg-6">
            <div className="row">
              <div id="carouselLeft" className="carousel slide" data-bs-touch="false" data-bs-interval="2000">
                <div className="carousel-inner">
                  <div className="carousel-item active">
